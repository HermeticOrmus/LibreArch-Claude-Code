...
A comprehensive pattern library and knowledge base for saga-patterns.

## Knowledge Base

### Core Concepts
- **Fundamentals**: The foundational principles that govern saga-patterns
...
- **Tools**: Common tools and frameworks used for saga-patterns

### Architecture Principles
- Separation of concerns within saga-patterns implementations
...
### Tools
- Development tools for saga-patterns
