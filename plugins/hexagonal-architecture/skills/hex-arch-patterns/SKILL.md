...
A comprehensive pattern library and knowledge base for hexagonal-architecture.

## Knowledge Base

### Core Concepts
- **Fundamentals**: The foundational principles that govern hexagonal-architecture
...
- **Tools**: Common tools and frameworks used for hexagonal-architecture

### Architecture Principles
- Separation of concerns within hexagonal-architecture implementations
...
### Tools
- Development tools for hexagonal-architecture
